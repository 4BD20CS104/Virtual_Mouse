...
# at this stage, the password contains only 4 characters but # we want a 12-characterpassword 
...
# prevent it from having a consistent pattern	# where the beginning of the password is predictable 
